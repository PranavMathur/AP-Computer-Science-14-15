...
public class Magpie6
{
   ...
   public Magpie6() {
      ...
      randomResponses.add("That's cool.");
      randomResponses.add("How does that work?");
      randomResponses.add("Can you elaborate?");
      randomResponses.add("I need more info.");
	...
	{
		return randomResponses.get((int)(Math.random()*randomResponses.size()));
	}
